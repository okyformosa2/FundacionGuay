...
import imagen from '@salesforce/resourceUrl/grafico';


export default class fondoconformulario extends LightningElement {
connectedCallback() {
  this.provincia = true;    
 }
